    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.Write("\nEnter a command (number or name of command): ");
        ...
        static void MarkAs()
        {
            Console.Write("Enter status (1 for completed, 0 for not completed): ");
            if (int.TryParse(Console.ReadLine(), out int status) && (status == 0 || status == 1))
            {
                ...
                if (taskName != null)
                {
                    ...
                    if (taskIndex != -1)
                    {
                        ...
                        tasks[taskIndex].CompletionDate = status == 1 ? DateTime.Now : DateTime.MinValue;
        ...
        static void Show()
        {
            Console.Write("Enter status (1 for completed, 0 for not completed, press enter for all tasks): ");
